-- ============================================================================
-- NFT Admin Dashboard - FINAL Production Database Schema
-- ============================================================================
...
-- ============================================================================
-- TABLE 1: BNPL Transactions (Final Production Ready)
-- ============================================================================
...
-- ============================================================================
-- TABLE 2: Weekly Subscriptions (Final Production Ready)
-- ============================================================================
...
-- ============================================================================
-- TABLE 3: NFT Insurance Logs (Final Production Ready)
-- ============================================================================
...
-- ============================================================================
-- TABLE 4: Global Transactions Table (Final Implementation)
-- ============================================================================
...
-- ============================================================================
-- GLOBAL TRANSACTIONS SYNC TRIGGER (Final Implementation)
-- ============================================================================
...
-- ============================================================================
-- ROW LEVEL SECURITY (RLS) - FINAL TIGHTENED POLICIES
-- ============================================================================
...
drop policy if exists "Authenticated users can view BNPL transactions" on public.bnpl_transactions;
drop policy if exists "Authenticated users can view subscriptions" on public.weekly_subscriptions;
drop policy if exists "Authenticated users can view insurance logs" on public.nft_insurance_logs;
...
-- TIGHTENED RLS POLICIES - Admin users can only view their own data OR if they're admin
-- Admin role check function (you'll need to implement this based on your user roles)
create or replace function public.is_admin_user()
returns boolean as $$
begin
    -- Check if current user has admin role in their metadata
    -- Adjust this based on your actual admin role implementation
    return exists (
...
-- BNPL Transactions - Admin can view all, users can view their own
create policy "bnpl_select_policy" 
...
create policy "bnpl_service_policy" 
    on public.bnpl_transactions for all
    using (auth.role() = 'service_role');

-- Weekly Subscriptions - Admin can view all, users can view their own
...
create policy "subscription_service_policy" 
    on public.weekly_subscriptions for all
    using (auth.role() = 'service_role');

-- NFT Insurance Logs - Admin can view all, users can view their own
create policy "insurance_select_policy" 
...
create policy "insurance_service_policy" 
    on public.nft_insurance_logs for all
    using (auth.role() = 'service_role');

-- Global Transactions - Admin can view all, users can view their own
...
-- ============================================================================
-- VIEWS: Admin Dashboard Queries (Final Production Ready)
-- ============================================================================
...
-- ============================================================================
-- GRANT PERMISSIONS (Final Production Ready)
-- ============================================================================

-- Grant access to authenticated users (read-only with RLS)
...
comment on function public.is_admin_user is 'Checks if current user has admin role';
comment on function public.sync_to_transactions is 'Syncs all transaction types to global transactions table';

-- ============================================================================
-- END OF FINAL PRODUCTION SCHEMA
-- ============================================================================

-- Success message
do $$
begin
    raise notice '✅ NFT Admin Dashboard FINAL PRODUCTION schema created successfully!';
    raise notice '📊 Tables created: bnpl_transactions, weekly_subscriptions, nft_insurance_logs, transactions';
    raise notice '🔗 Foreign keys: user_id linked to auth.users table';
    raise notice '🔄 Triggers enabled: auto-update timestamps + global sync';
    raise notice '🔒 RLS: TIGHTENED policies - users see own data, admins see all';
